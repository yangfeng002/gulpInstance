...
(function($) {
    ...
    /// ----- MGUI change begin -----
    /// Change root to mgui shared object
    ///
    ///   var root = this, // old code
    var root = $ && $.mgui ? $.mgui : this,
        /// ----- MGUI change end -----
        previous = root.Chart;
    ...
    Chart.Type.extend({
        ...
        initialize: function(data) {
            ...
            helpers.each(data.datasets, function(dataset) {
                /// ----- MGUI change begin -----
                // add color theme
                if($.mgui && $.mgui.Color && $.mgui.Color.get) {
                    var accentColor = $.mgui.Color.get(dataset.color);
...
(function($) {
    ...
    Chart.Type.extend({
        ...
        addData: function(segment, atIndex, silent) {
            ...
            /// Init segment color
            if($.mgui && $.mgui.Color && $.mgui.Color.get) {
                var color = new $.mgui.Color.get(segment.color);
        ...
        drawLabel: function(segment, easeDecimal, labelPosMap) {
            ...
            if(placement === 'outside') { // outside
                ...
                x = isRight ? (x + 5) : (x - 5);
                ctx.lineTo(x, y);
                ctx.strokeStyle = ($.mgui && $.mgui.Color) ? (new $.mgui.Color(segment.fillColor).fade(40).toCssStr()) : segment.fillColor;
                ...
                ctx.fillStyle = ($.mgui && $.mgui.Color) ? (new $.mgui.Color(segment.fillColor).contrast().toCssStr()) : '#fff';
            }
