...
(function($) {
    ...
    var name = 'mgui.colorPicker'; // modal name
    ...
    ColorPicker.prototype.init = function() {
        ...
        $.each(options.colors, function(idx, rawColor) {
            if($.mgui.Color.isColor(rawColor)) {
                var color = new $.mgui.Color(rawColor);
        ...
        var setInputColor = function() {
            var val = $input.val();
            var isColor = $.mgui.Color.isColor(val);
    ...
    ColorPicker.prototype.addColor = function(color) {
        if(!(color instanceof $.mgui.Color)) {
            color = new $.mgui.Color(color);
        }
    ...
    ColorPicker.prototype.getOptions = function(options) {
        ...
        var lang = (thisOptions.lang || $.mgui.clientLang()).toLowerCase();
