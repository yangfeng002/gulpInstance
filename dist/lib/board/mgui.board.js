...
(function($) {
    ...
    Boards.prototype.getOptions = function(options) {
        options = $.extend({lang: $.mgui.clientLang()}, Boards.DEFAULTS, this.$.data(), options);
        return options;
    };
    ...
    $.fn.boards = function(option) {
        return this.each(function() {
            var $this = $(this);
            var data = $this.data('mgui.boards');
            var options = typeof option == 'object' && option;

            if(!data) $this.data('mgui.boards', (data = new Boards(this, options)));
