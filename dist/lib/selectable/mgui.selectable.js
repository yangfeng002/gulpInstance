...
(function($) {
    ...
    var name = 'mgui.selectable'; // module name
    ...
    Selectable.DEFAULTS = {
        ...
        selectClass: 'active',
        rangeStyle: {
            border: '1px solid ' + ($.mgui.colorset ? $.mgui.colorset.primary : '#3280fc'),
            backgroundColor: $.mgui.colorset ? (new $.mgui.Color($.mgui.colorset.primary).fade(20).toCssStr()) : 'rgba(50, 128, 252, 0.2)'
        },
    ...
    Selectable.prototype._init = function() {
        ...
        var mousedown = function(e) {
            ...
            var mouseButton = $.mgui.getMouseButtonCode(options.mouseButton);
