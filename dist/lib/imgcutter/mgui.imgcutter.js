...
(function($, Math, undefined) {
    ...
    if(!$.mgui.imgReady) console.error('img-cutter requires image.ready.js');

    var NAME = 'mgui.imgCutter';
    ...
    ImgCutter.prototype.initSize = function() {
        var that = this;
        if(!that.imgWidth) {
            $.mgui.imgReady(that.options.img, function() {
