...
(function($) {
    ...
    var name = 'mgui.datatable';
    var store = $.mgui.store;
    ...
    var DataTable = function(element, options) {
        ...
        if(this.isTable) {
            this.$table = this.$;
            this.id = 'datatable-' + (this.$.attr('id') || $.mgui.uuid());
        } else {
            this.$datatable = this.$.addClass('datatable');
            if(this.$.attr('id')) {
                this.id = this.$.attr('id');
            } else {
                this.id = 'datatable-' + $.mgui.uuid();
    ...
    DataTable.prototype.bindEvents = function() {
        ...
        if(options.checkable) {
            ...
            var checkEventPrefix = 'click.mgui.datatable.check';
            ...
            this.$datatable.off(checkEventPrefix).on('click.mgui.datatable.check', '.check-all', function() {
