...
(function($, window, Plupload, Moxie, undefined) {
    ...
    var notSupportDnd = ($.mgui.browser && $.mgui.browser.ie && $.mgui.browser.ie < 11);

    var NAME = 'mgui.uploader', // modal name
    ...
    var Uploader = function(element, options) {
        ...
        // Init lang
        var lang = $.isPlainObject(options.lang) ? ($.extend(true, {}, Uploader.LANG[lang.lang || $.mgui.clientLang()], options.lang)) : Uploader.LANG[options.lang];
        that.lang = lang;
    ...
    Uploader.prototype.showFile = function(file, responseObject) {
        ...
        if(options.fileFormater) {
            ...
            $file.find('.file-icon').html(options.fileIconCreator ? options.fileIconCreator(file.type, file, that) : that.createFileIcon(file)).css('color', 'hsl(' + $.mgui.strCode(file.type || file.ext) + ', 70%, 40%)');
    ...
    $.mgui.plupload = Plupload;
    $.mgui.moxie    = Moxie;
    $.mgui.Uploader = Uploader;
