...
(function($, window) {
    ...
    var Calendar = function(element, options) {
        this.name = NAME;
        this.$ = $(element);
        this.id = this.$.attr('id') || (NAME + $.mgui.uuid());
        ...
        this.storeData = $.mgui.store.pageGet(this.storeName, {
            date: 'today',
            view: 'month'
        });
    ...
    Calendar.prototype.addCalendars = function(calendars, silence) {
        ...
        $.each(calendars, function(index, cal) {
            ...
            if(!presetColors[cal.color.toLowerCase()]) {
                var c = new $.mgui.Color(cal.color);
    ...
    Calendar.prototype.getLang = function() {
        this.lang = this.options.langs[(this.options.lang || ($.mgui && $.mgui.clientLang ? $.mgui.clientLang() : 'zh_cn')).replace('-', '_')];
    };
    ...
    Calendar.prototype.display = function(view, date) {
        ...
        if(that.options.storage) {
            $.mgui.store.pageSet(that.storeName, {
                date: date,
                view: view
            });
        }
