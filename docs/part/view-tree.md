...
<example>
  <nav class="menu" data-ride="menu" style="width: 200px">
    <ul id="treeMenu" class="tree tree-menu" data-ride="tree">
      <li><a href="#"><i class="fa fa-th"></i>首页</a></li>
      <li><a href="#"><i class="fa fa-user"></i>个人资料</a></li>
      <li>
        <a href="#"><i class="fa fa-time"></i>更新时间</a>
        <ul>
          <li><a href="#">今天</a></li>
          <li><a href="#">明天</a></li>
          <li><a href="#">昨天</a></li>
      ...
      <li><a href="#"><i class="fa fa-trash"></i>垃圾篓</a></li>
      <li><a href="#"><i class="fa fa-list-ul"></i>全部</a></li>
      <li class="open">
        ...
        <ul>
          ...
          <li class="active"><a href="#"><i class="fa fa-play-sign"></i>进行中</a></li>
...
```js
// 使用 tree 实例
var myTree = $('#tree').data('mgui.tree');
...
```js
// 获取 tree 实例
var myTree = $('#myTree').data('mgui.tree');
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>`expand`</td>
      <td>`expand.mgui.tree`</td>
      <td>当菜单展开之后会触发此事件</td>
    </tr>
    <tr>
      <td>`collapse`</td>
      <td>`collapse.mgui.tree`</td>
...
```js
// 通过jQuery方法绑定事件
$('#tree').on('expand.mgui.tree', function(){...});
