...
(function(root, factory) {
    ...
    var defaults = {
        // default language
        locale: $.mgui && $.mgui.clientLang ? $.mgui.clientLang() : 'zh_cn',
    ...
    exports.prompt = function() {
        ...
        dialog.off("shown.mgui.modal");

        // ...and replace it with one focusing our input, if possible
        dialog.on("shown.mgui.modal", function() {
    ...
    exports.dialog = function(options) {
        ...
        dialog.on("hidden.mgui.modal", function(e) {
        ...
        /*
        dialog.on("show.mgui.modal", function() {
        ...
        */
        ...
        if(options.backdrop !== "static") {
            ...
            dialog.on("click.dismiss.mgui.modal", function(e) {
