...
(function($, window, document, Math) {
    ...
    var Mindmap = function(element, options) {
        ...
        if(!this.options.hotkeyEnable) {
            $.mgui.messager.show(this.lang.hotkeyDisabled);
        }
    };
    ...
    Mindmap.prototype.initDom = function() {
        ...
        if(!$this.attr('id')) {
            $this.attr('id', 'mindmap-' + $.mgui.uuid());
        }
    ...
    Mindmap.prototype.loadNode = function(nodeData, parent, index) {
        ...
        if(typeof(nodeData.id) === UDF) nodeData.id = $.mgui.uuid() + '';
    ...
    $.fn.mindmap = function(option) {
        return this.each(function() {
            var $this = $(this);
            var data = $this.data('mgui.mindmap');
            var options = typeof option == 'object' && option;

            if(!data) $this.data('mgui.mindmap', (data = new Mindmap(this, options)));
